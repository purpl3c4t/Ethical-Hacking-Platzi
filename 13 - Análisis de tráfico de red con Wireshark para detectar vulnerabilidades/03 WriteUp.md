# Challenge [0013]: [Análisis de tráfico de red con Wireshark para detectar vulnerabilidades]

| Información | Detalle |
| :--- | :--- |
| **Tema** | Análisis de tráfico de red con Wireshark para detectar vulnerabilidades |
| **Dificultad** | [Media] |
