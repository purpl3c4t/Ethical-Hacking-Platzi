# [Clase0018]: [Vulnerabilidades mobile: funcionamiento y detección práctica]

| Metadatos | Detalle |
| :--- | :--- |
| **Fecha** | YYYY-MM-DD |
| **Tiempo estimado** | 2 horas |
| **Tema** | Vulnerabilidades mobile: funcionamiento y detección práctica |
| **Resultado** | Iniciar tu propio framework de pruebas de penetración para aplicaciones móviles ANDROID|
