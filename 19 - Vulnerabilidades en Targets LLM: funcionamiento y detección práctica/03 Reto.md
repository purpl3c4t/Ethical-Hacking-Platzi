# Challenge [0019]: [Vulnerabilidades en Targets LLM: funcionamiento y detección práctica]

| Información | Detalle |
| :--- | :--- |
| **Tema** | Vulnerabilidades en Targets LLM: funcionamiento y detección práctic |
| **Dificultad** | [Media] |
