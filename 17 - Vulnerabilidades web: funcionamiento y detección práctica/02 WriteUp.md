# [Clase0017]: [Vulnerabilidades web: funcionamiento y detección práctica]

| Metadatos | Detalle |
| :--- | :--- |
| **Fecha** | YYYY-MM-DD |
| **Tiempo estimado** | 2 horas |
| **Tema** | Vulnerabilidades web: funcionamiento y detección práctica|
| **Resultado** | Practicar el reconocimiento de la causa raíz de vulnerabilidades web y explotarlas|
