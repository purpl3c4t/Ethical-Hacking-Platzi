...
Debe diseccionar el reporte generado previamente para extraer inteligencia accionable.
...
Ahora debe realizar su propio escaneo utilizando una política estándar de la industria.
...
### Tarea 3: Verificación y Prueba de Concepto (Comparativa)
Debe contrastar ambos para entender las diferencias.
