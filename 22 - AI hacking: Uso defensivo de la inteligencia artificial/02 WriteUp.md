# [Clase0022]: [AI hacking: Uso defensivo de la inteligencia artificial]

| Metadatos | Detalle |
| :--- | :--- |
| **Fecha** | YYYY-MM-DD |
| **Tiempo estimado** | 2 horas |
| **Tema** | AI hacking: Uso defensivo de la inteligencia artificial |
| **Resultado** | Implementar MCP y realizar diversos análisis de malware |
