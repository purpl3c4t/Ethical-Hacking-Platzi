# [Clase0021]: [AI Hacking: armamento de la inteligencia artificial]

| Metadatos | Detalle |
| :--- | :--- |
| **Fecha** | YYYY-MM-DD |
| **Tiempo estimado** | 2 horas |
| **Tema** | AI Hacking: armamento de la inteligencia artificial|
| **Resultado** | Configuración y pruebas de un MCPAnalyzer para el entorno de pruebas de AWS|
